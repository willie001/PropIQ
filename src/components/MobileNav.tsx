    ...
    <div className="md:hidden">
      ...
      {open && (
        <div className="fixed inset-0 z-50 bg-slate-950">
          ...
          {/* ❗ NEW PANEL WRAPPER ADDED HERE */}
          <div className="mx-4 mt-4 rounded-xl bg-slate-900 p-4 border border-slate-700 space-y-2">
            {navItems.map((item) => {
                ...
                <button
                  ...
                  className={`block w-full text-left rounded-lg border px-4 py-3 text-base transition ${
                    isActive
                      ...
                      : "border-slate-700 bg-slate-800 text-slate-100 hover:border-emerald-400 hover:text-emerald-100"
                  }`}
                >
                  {item.label}
                </button>
